package com.facebook.backend.common.http;

import com.facebook.backend.common.constant.CookieConstant;
import com.facebook.backend.common.constant.HttpConstant;
import com.facebook.backend.common.i18n.I18nService;
...
/**
 * With each HTTP Servlet Request, a diversity of headers is provided.
...
public record HttpRequestServiceImpl(
    ...
    /** Extract the refresh token from the cookie using the Http Servlet Request.
