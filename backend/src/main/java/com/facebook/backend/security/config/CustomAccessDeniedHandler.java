...
import com.facebook.backend.common.payload.response.UnauthorizedResponse;
import com.facebook.backend.security.cookie.CookieService;
...
record CustomAccessDeniedHandler(
    ...
    /**
     * Handle access denied exception by customizing the response sent to the client.
     *
